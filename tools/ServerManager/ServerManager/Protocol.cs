...
namespace ServerManager
{
    class Protocol
    {
        ...
        public String ToString()
        {
            ...
            return "长度:" + shortToHexString(len) + "\n帧序:" + byteToHexString(frame_id) + "\n控制字:" + byteToHexString(f_ctrl) + "\n目的地址:" + shortToHexString(dst_network_addr)
                + "\n来源地址:" + shortToHexString(src_network_addr) + "\n数据域控制字:" + byteToHexString(p_ctrl) + "\n数据ID:" + byteToHexString(p_data_id) + "\n数据内容:" + bytesToHexString(p_data, 0, p_data_len);
        }
